...
#==============================================================================
# FAST
lgAges = np.log10(np.linspace(1.,8.5,76)* 1e9)
...
dir = glob.glob('Aldo/ST/4color/M*_0.3_ST.spec.4color') 
...
np.savetxt('Aldo/ST/m0.3 CSP result.txt',info,fmt='%.7e',header='M_today lgT lgM* lgsSFR')
